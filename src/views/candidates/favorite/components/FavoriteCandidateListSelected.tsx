...
const FavoriteCandidateListSelected = () => {
  const {
  ...
  const handleConfirmDelete = async () => {
    await Promise.all(
      favoriteCandidateList.map((candidate) => {
  ...
  return (
    <>
      {selectedFavoriteCandidate.length > 0 && (
        <StickyFooter
                  ...
                  <span className="flex items-center gap-2">
                    ...
                    <span className="font-semibold flex items-center gap-1">
                      <span className="heading-text">
                        {selectedFavoriteCandidate.length} Candidatos Favoritos
                      </span>
...
export default FavoriteCandidateListSelected;
