...
const recruiterJob: NavigationTree = {
  key: 'job',
  path: '',
  title: 'Job',
...
const recruiterFreeSubscription: NavigationTree = {
  key: 'candidates',
  path: '',
  title: 'Candidates',
...
const allCandidates: NavigationTree = {
  key: 'candidates.all',
...
const recruiterArchive: NavigationTree = {
  key: 'archive',
  path: '',
  title: 'Archive',
  ...
  switch (role) {
    case FrontendRole.RECRUITER:
      ...
      return [
        home,
        recruiterJob,
        // Include premium access to all candidates
        {
          ...recruiterFreeSubscription,
          subMenu: [...recruiterFreeSubscription.subMenu, allCandidates],
        },
        recruiterArchive,
        {
          key: 'membershipPlans',
